...
def __getValuesFromRegisters():
    sensors['rpm'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.rpm)
    sensors['torque'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.torque)
    sensors['pressure_in'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.pressure_in)
    sensors['pressure_out'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.pressure_out)
    sensors['flow05'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.flow05)
    sensors['flow1'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.flow1)
    sensors['flow2'] = __private.adam.getValue(Adam5K.SlotType.ANALOG, *adam_config.flow2)
