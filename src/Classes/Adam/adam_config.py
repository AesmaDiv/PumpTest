...
PARAMS = {
    ...
    ChannelNames.FLW_0:   Param(SlotType.ANALOG,  0, 0,   203, 0x0000, 0xFFFF), # расходомер 0.5"
    ChannelNames.FLW_1:   Param(SlotType.ANALOG,  0, 1,   269, 0x0000, 0xFFFF), # расходомер 1"
    ...
    ChannelNames.SPEED:   Param(SlotType.ANALOG,  1, 0,  3000, 0x0000, 0x0FFF), # частотник
    ChannelNames.VLV_2:   Param(SlotType.DIGITAL, 2, 3,     0, 0x0000, 0xFF00), # кран 0 - 2" <> 1 - 1"(0.5")
    ChannelNames.VLV_1:   Param(SlotType.DIGITAL, 2, 4,     0, 0x0000, 0xFF00), # кран 0 - 1" <> 1 - 0.5"
    ...
    ChannelNames.VLV_FLW: Param(SlotType.ANALOG,  1, 1,  4095, 0x0000, 0x0FFF), # клапан расхода
}
